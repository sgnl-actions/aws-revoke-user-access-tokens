...
const a$4 = true, b$4 = "isSet", c$4 = "booleanEquals", d$4 = "error", e$4 = "endpoint", f$4 = "tree", g$4 = "PartitionResult", h$4 = "stringEquals", i$4 = "sigv4", j$4 = { [H$1]: true, "default": false, "type": "boolean" }, k$4 = { [H$1]: false, "type": "string" }, l$4 = { [K]: "Endpoint" }, m$4 = { [I$1]: c$4, [J$1]: [{ [K]: "UseFIPS" }, true] }, n$4 = { [I$1]: c$4, [J$1]: [{ [K]: "UseDualStack" }, true] }, o$4 = {}, p$4 = { [I$1]: h$4, [J$1]: [{ [I$1]: "getAttr", [J$1]: [{ [K]: g$4 }, "name"] }, "aws"] }, q$4 = { [I$1]: "getAttr", [J$1]: [{ [K]: g$4 }, "name"] }, r$4 = { [I$1]: c$4, [J$1]: [{ [K]: "UseFIPS" }, false] }, s$4 = { [N]: [{ [O]: i$4, [P]: "us-east-1" }] }, t$4 = { [I$1]: h$4, [J$1]: [q$4, "aws-cn"] }, u$4 = { [N]: [{ [O]: i$4, [P]: "cn-north-1" }] }, v$4 = { [I$1]: c$4, [J$1]: [{ [K]: "UseDualStack" }, false] }, w$4 = { [I$1]: h$4, [J$1]: [q$4, "aws-us-gov"] }, x$4 = { "url": "https://iam.us-gov.api.aws", [L]: { [N]: [{ [O]: i$4, [P]: "us-gov-west-1" }] }, [M]: {} }, y$1 = { "url": "https://iam.us-gov.amazonaws.com", [L]: { [N]: [{ [O]: i$4, [P]: "us-gov-west-1" }] }, [M]: {} }, z$1 = { [I$1]: h$4, [J$1]: [q$4, "aws-iso"] }, A$1 = { [N]: [{ [O]: i$4, [P]: "us-iso-east-1" }] }, B$1 = { [I$1]: h$4, [J$1]: [q$4, "aws-iso-b"] }, C$1 = { [N]: [{ [O]: i$4, [P]: "us-isob-east-1" }] }, D$1 = { [I$1]: "getAttr", [J$1]: [{ [K]: g$4 }, "supportsFIPS"] }, E$1 = { [I$1]: c$4, [J$1]: [true, { [I$1]: "getAttr", [J$1]: [{ [K]: g$4 }, "supportsDualStack"] }] }, F$1 = { [N]: [{ [O]: i$4, [P]: "{PartitionResult#implicitGlobalRegion}" }] }, G$1 = [{ [K]: "Region" }];
const _data$4 = { parameters: { UseDualStack: j$4, UseFIPS: j$4, Endpoint: k$4, Region: k$4 }, rules: [{ conditions: [{ [I$1]: b$4, [J$1]: [l$4] }], rules: [{ conditions: [m$4], error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: d$4 }, { rules: [{ conditions: [n$4], error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: d$4 }, { endpoint: { url: l$4, [L]: o$4, [M]: o$4 }, type: e$4 }], type: f$4 }], type: f$4 }, { rules: [{ conditions: [{ [I$1]: b$4, [J$1]: G$1 }], rules: [{ conditions: [{ [I$1]: "aws.partition", [J$1]: G$1, assign: g$4 }], rules: [{ conditions: [p$4, r$4, n$4], endpoint: { url: "https://iam.global.api.aws", [L]: s$4, [M]: o$4 }, type: e$4 }, { conditions: [p$4, m$4, n$4], endpoint: { url: "https://iam-fips.global.api.aws", [L]: s$4, [M]: o$4 }, type: e$4 }, { conditions: [t$4, r$4, n$4], endpoint: { url: "https://iam.global.api.amazonwebservices.com.cn", [L]: u$4, [M]: o$4 }, type: e$4 }, { conditions: [t$4, r$4, v$4], endpoint: { url: "https://iam.cn-north-1.amazonaws.com.cn", [L]: u$4, [M]: o$4 }, type: e$4 }, { conditions: [w$4, r$4, n$4], endpoint: x$4, type: e$4 }, { conditions: [w$4, m$4, n$4], endpoint: x$4, type: e$4 }, { conditions: [w$4, r$4, v$4], endpoint: y$1, type: e$4 }, { conditions: [w$4, m$4, v$4], endpoint: y$1, type: e$4 }, { conditions: [z$1, r$4, v$4], endpoint: { url: "https://iam.us-iso-east-1.c2s.ic.gov", [L]: A$1, [M]: o$4 }, type: e$4 }, { conditions: [z$1, m$4, v$4], endpoint: { url: "https://iam-fips.us-iso-east-1.c2s.ic.gov", [L]: A$1, [M]: o$4 }, type: e$4 }, { conditions: [B$1, r$4, v$4], endpoint: { url: "https://iam.us-isob-east-1.sc2s.sgov.gov", [L]: C$1, [M]: o$4 }, type: e$4 }, { conditions: [B$1, m$4, v$4], endpoint: { url: "https://iam-fips.us-isob-east-1.sc2s.sgov.gov", [L]: C$1, [M]: o$4 }, type: e$4 }, { conditions: [{ [I$1]: h$4, [J$1]: [q$4, "aws-iso-e"] }, r$4, v$4], endpoint: { url: "https://iam.eu-isoe-west-1.cloud.adc-e.uk", [L]: { [N]: [{ [O]: i$4, [P]: "eu-isoe-west-1" }] }, [M]: o$4 }, type: e$4 }, { conditions: [{ [I$1]: h$4, [J$1]: [q$4, "aws-iso-f"] }, r$4, v$4], endpoint: { url: "https://iam.us-isof-south-1.csp.hci.ic.gov", [L]: { [N]: [{ [O]: i$4, [P]: "us-isof-south-1" }] }, [M]: o$4 }, type: e$4 }, { conditions: [{ [I$1]: h$4, [J$1]: [q$4, "aws-eusc"] }, r$4, v$4], endpoint: { url: "https://iam.eusc-de-east-1.amazonaws.eu", [L]: { [N]: [{ [O]: i$4, [P]: "eusc-de-east-1" }] }, [M]: o$4 }, type: e$4 }, { conditions: [m$4, n$4], rules: [{ conditions: [{ [I$1]: c$4, [J$1]: [a$4, D$1] }, E$1], rules: [{ endpoint: { url: "https://iam-fips.{PartitionResult#dualStackDnsSuffix}", [L]: F$1, [M]: o$4 }, type: e$4 }], type: f$4 }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: d$4 }], type: f$4 }, { conditions: [m$4, v$4], rules: [{ conditions: [{ [I$1]: c$4, [J$1]: [D$1, a$4] }], rules: [{ endpoint: { url: "https://iam-fips.{PartitionResult#dnsSuffix}", [L]: F$1, [M]: o$4 }, type: e$4 }], type: f$4 }, { error: "FIPS is enabled but this partition does not support FIPS", type: d$4 }], type: f$4 }, { conditions: [r$4, n$4], rules: [{ conditions: [E$1], rules: [{ endpoint: { url: "https://iam.{PartitionResult#dualStackDnsSuffix}", [L]: F$1, [M]: o$4 }, type: e$4 }], type: f$4 }, { error: "DualStack is enabled but this partition does not support DualStack", type: d$4 }], type: f$4 }, { endpoint: { url: "https://iam.{PartitionResult#dnsSuffix}", [L]: F$1, [M]: o$4 }, type: e$4 }], type: f$4 }], type: f$4 }, { error: "Invalid Configuration: Missing Region", type: d$4 }], type: f$4 }] };
...
const _ICE$1 = "InvalidCertificateException";
...
const _m$3 = "message";
const _s$4 = "server";
const _sm$2 = "smithy.ts.sdk.synthetic.com.amazonaws.iam";
const n0$4 = "com.amazonaws.iam";
var AccessKeyMetadata$ = [3, n0$4, _AKM,
    0,
    [_UN, _AKI$1, _S, _CD],
    [0, 0, 0, 4]
];
var AccountNotManagementOrDelegatedAdministratorException$ = [-3, n0$4, _ANMODAE,
    { [_e$4]: _c$4, [_hE$4]: 400 },
    [_M],
    [0]
];
TypeRegistry.for(n0$4).registerError(AccountNotManagementOrDelegatedAdministratorException$, AccountNotManagementOrDelegatedAdministratorException);
var CallerIsNotManagementAccountException$ = [-3, n0$4, _CINMAE,
    { [_e$4]: _c$4, [_hE$4]: 400 },
    [_M],
    [0]
];
TypeRegistry.for(n0$4).registerError(CallerIsNotManagementAccountException$, CallerIsNotManagementAccountException);
var ConcurrentModificationException$ = [-3, n0$4, _CME,
    { [_aQE$1]: [`ConcurrentModification`, 409], [_e$4]: _c$4, [_hE$4]: 409 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(ConcurrentModificationException$, ConcurrentModificationException);
var CredentialReportExpiredException$ = [-3, n0$4, _CREE,
    { [_aQE$1]: [`ReportExpired`, 410], [_e$4]: _c$4, [_hE$4]: 410 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(CredentialReportExpiredException$, CredentialReportExpiredException);
var CredentialReportNotPresentException$ = [-3, n0$4, _CRNPE,
    { [_aQE$1]: [`ReportNotPresent`, 410], [_e$4]: _c$4, [_hE$4]: 410 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(CredentialReportNotPresentException$, CredentialReportNotPresentException);
var CredentialReportNotReadyException$ = [-3, n0$4, _CRNRE,
    { [_aQE$1]: [`ReportInProgress`, 404], [_e$4]: _c$4, [_hE$4]: 404 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(CredentialReportNotReadyException$, CredentialReportNotReadyException);
var DeleteAccessKeyRequest$ = [3, n0$4, _DAKR,
    0,
    [_AKI$1, _UN],
    [0, 0], 1
];
var DeleteConflictException$ = [-3, n0$4, _DCE,
    { [_aQE$1]: [`DeleteConflict`, 409], [_e$4]: _c$4, [_hE$4]: 409 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(DeleteConflictException$, DeleteConflictException);
var DuplicateCertificateException$ = [-3, n0$4, _DCEu,
    { [_aQE$1]: [`DuplicateCertificate`, 409], [_e$4]: _c$4, [_hE$4]: 409 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(DuplicateCertificateException$, DuplicateCertificateException);
var DuplicateSSHPublicKeyException$ = [-3, n0$4, _DSSHPKE,
    { [_aQE$1]: [`DuplicateSSHPublicKey`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(DuplicateSSHPublicKeyException$, DuplicateSSHPublicKeyException);
var EntityAlreadyExistsException$ = [-3, n0$4, _EAEE,
    { [_aQE$1]: [`EntityAlreadyExists`, 409], [_e$4]: _c$4, [_hE$4]: 409 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(EntityAlreadyExistsException$, EntityAlreadyExistsException);
var EntityTemporarilyUnmodifiableException$ = [-3, n0$4, _ETUE,
    { [_aQE$1]: [`EntityTemporarilyUnmodifiable`, 409], [_e$4]: _c$4, [_hE$4]: 409 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(EntityTemporarilyUnmodifiableException$, EntityTemporarilyUnmodifiableException);
var FeatureDisabledException$ = [-3, n0$4, _FDE,
    { [_aQE$1]: [`FeatureDisabled`, 404], [_e$4]: _c$4, [_hE$4]: 404 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(FeatureDisabledException$, FeatureDisabledException);
var FeatureEnabledException$ = [-3, n0$4, _FEE,
    { [_aQE$1]: [`FeatureEnabled`, 409], [_e$4]: _c$4, [_hE$4]: 409 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(FeatureEnabledException$, FeatureEnabledException);
var InvalidAuthenticationCodeException$ = [-3, n0$4, _IACE,
    { [_aQE$1]: [`InvalidAuthenticationCode`, 403], [_e$4]: _c$4, [_hE$4]: 403 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(InvalidAuthenticationCodeException$, InvalidAuthenticationCodeException);
var InvalidCertificateException$ = [-3, n0$4, _ICE$1,
    { [_aQE$1]: [`InvalidCertificate`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(InvalidCertificateException$, InvalidCertificateException);
var InvalidInputException$ = [-3, n0$4, _IIE,
    { [_aQE$1]: [`InvalidInput`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(InvalidInputException$, InvalidInputException);
var InvalidPublicKeyException$ = [-3, n0$4, _IPKE,
    { [_aQE$1]: [`InvalidPublicKey`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(InvalidPublicKeyException$, InvalidPublicKeyException);
var InvalidUserTypeException$ = [-3, n0$4, _IUTE,
    { [_aQE$1]: [`InvalidUserType`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(InvalidUserTypeException$, InvalidUserTypeException);
var KeyPairMismatchException$ = [-3, n0$4, _KPME,
    { [_aQE$1]: [`KeyPairMismatch`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(KeyPairMismatchException$, KeyPairMismatchException);
var LimitExceededException$ = [-3, n0$4, _LEE,
    { [_aQE$1]: [`LimitExceeded`, 409], [_e$4]: _c$4, [_hE$4]: 409 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(LimitExceededException$, LimitExceededException);
var ListAccessKeysRequest$ = [3, n0$4, _LAKR,
    0,
    [_UN, _Ma, _MI],
    [0, 0, 1]
];
var ListAccessKeysResponse$ = [3, n0$4, _LAKRi,
    0,
    [_AKM, _IT$1, _Ma],
    [() => accessKeyMetadataListType, 2, 0], 1
];
var MalformedCertificateException$ = [-3, n0$4, _MCE,
    { [_aQE$1]: [`MalformedCertificate`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(MalformedCertificateException$, MalformedCertificateException);
var MalformedPolicyDocumentException$$1 = [-3, n0$4, _MPDE$1,
    { [_aQE$1]: [`MalformedPolicyDocument`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(MalformedPolicyDocumentException$$1, MalformedPolicyDocumentException$1);
var NoSuchEntityException$ = [-3, n0$4, _NSEE,
    { [_aQE$1]: [`NoSuchEntity`, 404], [_e$4]: _c$4, [_hE$4]: 404 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(NoSuchEntityException$, NoSuchEntityException);
var OpenIdIdpCommunicationErrorException$ = [-3, n0$4, _OIICEE,
    { [_aQE$1]: [`OpenIdIdpCommunicationError`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(OpenIdIdpCommunicationErrorException$, OpenIdIdpCommunicationErrorException);
var OrganizationNotFoundException$ = [-3, n0$4, _ONFE,
    { [_e$4]: _c$4, [_hE$4]: 400 },
    [_M],
    [0]
];
TypeRegistry.for(n0$4).registerError(OrganizationNotFoundException$, OrganizationNotFoundException);
var OrganizationNotInAllFeaturesModeException$ = [-3, n0$4, _ONIAFME,
    { [_e$4]: _c$4, [_hE$4]: 400 },
    [_M],
    [0]
];
TypeRegistry.for(n0$4).registerError(OrganizationNotInAllFeaturesModeException$, OrganizationNotInAllFeaturesModeException);
var PasswordPolicyViolationException$ = [-3, n0$4, _PPVE,
    { [_aQE$1]: [`PasswordPolicyViolation`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(PasswordPolicyViolationException$, PasswordPolicyViolationException);
var PolicyEvaluationException$ = [-3, n0$4, _PEE,
    { [_aQE$1]: [`PolicyEvaluation`, 500], [_e$4]: _s$4, [_hE$4]: 500 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(PolicyEvaluationException$, PolicyEvaluationException);
var PolicyNotAttachableException$ = [-3, n0$4, _PNAE,
    { [_aQE$1]: [`PolicyNotAttachable`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(PolicyNotAttachableException$, PolicyNotAttachableException);
var ReportGenerationLimitExceededException$ = [-3, n0$4, _RGLEE,
    { [_aQE$1]: [`ReportGenerationLimitExceeded`, 409], [_e$4]: _c$4, [_hE$4]: 409 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(ReportGenerationLimitExceededException$, ReportGenerationLimitExceededException);
var ServiceAccessNotEnabledException$ = [-3, n0$4, _SANEE,
    { [_e$4]: _c$4, [_hE$4]: 400 },
    [_M],
    [0]
];
TypeRegistry.for(n0$4).registerError(ServiceAccessNotEnabledException$, ServiceAccessNotEnabledException);
var ServiceFailureException$ = [-3, n0$4, _SFE,
    { [_aQE$1]: [`ServiceFailure`, 500], [_e$4]: _s$4, [_hE$4]: 500 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(ServiceFailureException$, ServiceFailureException);
var ServiceNotSupportedException$ = [-3, n0$4, _SNSE,
    { [_aQE$1]: [`NotSupportedService`, 404], [_e$4]: _c$4, [_hE$4]: 404 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(ServiceNotSupportedException$, ServiceNotSupportedException);
var UnmodifiableEntityException$ = [-3, n0$4, _UEE,
    { [_aQE$1]: [`UnmodifiableEntity`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(UnmodifiableEntityException$, UnmodifiableEntityException);
var UnrecognizedPublicKeyEncodingException$ = [-3, n0$4, _UPKEE,
    { [_aQE$1]: [`UnrecognizedPublicKeyEncoding`, 400], [_e$4]: _c$4, [_hE$4]: 400 },
    [_m$3],
    [0]
];
TypeRegistry.for(n0$4).registerError(UnrecognizedPublicKeyEncodingException$, UnrecognizedPublicKeyEncodingException);
var __Unit = "unit";
var IAMServiceException$ = [-3, _sm$2, "IAMServiceException", 0, [], []];
TypeRegistry.for(_sm$2).registerError(IAMServiceException$, IAMServiceException);
var accessKeyMetadataListType = [1, n0$4, _aKMLT,
    0, () => AccessKeyMetadata$
];
var DeleteAccessKey$ = [9, n0$4, _DAK,
    0, () => DeleteAccessKeyRequest$, () => __Unit
];
var ListAccessKeys$ = [9, n0$4, _LAK,
